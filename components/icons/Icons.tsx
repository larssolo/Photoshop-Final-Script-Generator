...
export const DragHandleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 5.25h13.5m-13.5 4.5h13.5m-13.5 4.5h13.5m-13.5 4.5h13.5" />
    </svg>
);
...
export const RotateIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 10.5v3a9 9 0 0 0 9 9h7.5" />
    </svg>
);

export const ColorSwatchIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.098 19.902a3.75 3.75 0 0 0 5.304 0l6.401-6.402a3.75 3.75 0 0 0-5.304-5.304L4.098 14.6c-.43.43-.807.9-1.11 1.414a3.75 3.75 0 0 0-.215 3.184.75.75 0 0 0 .53.53Zm0 0a3.75 3.75 0 0 0 5.304 0l6.401-6.402a3.75 3.75 0 0 0-5.304-5.304L4.098 14.6c-.43.43-.807.9-1.11 1.414a3.75 3.75 0 0 0-.215 3.184.75.75 0 0 0 .53.53Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.75v.75m0 0v.75m0-1.5h.75m-.75 0h-.75m-6 6v.75m0 0v.75m0-1.5h.75m-.75 0h-.75m6-6.75h.75m0 0h.75m-1.5 0v.75m0-.75v-.75m-6 6.75h.75m0 0h.75m-1.5 0v.75m0-.75v-.75" />
    </svg>
);

export const BranchIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 3v4a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3V3M6 21v-4a3 3 0 0 1 3-3h6a3 3 0 0 1 3 3v4M12 10.5v3" />
    </svg>
);
...
export const FlattenIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 7.5h18M3 12h18M3 16.5h18" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 4.5 12 3l5 1.5M7 19.5 12 21l5-1.5" />
    </svg>
);

export const MetadataIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
